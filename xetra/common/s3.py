...
class S3BucketConnector():
    ...
    def __init__(self, access_key: str, secret_key: str, endpoint_url: str, bucket: str):
        ...
        :param access_key: acceess key for accessing S3
     ...
     """
        ...
        self._s3 = self.session.client(service_name='s3', endpoint_url=endpoint_url)
    ...
    def list_files_in_prefix(self, prefix: str):
        ...
        :param prefix: prefix on the S3 bucket that shoudl be filtered with
